...
void screen_main(void)
{
	...
	//lv_obj_set_style_bg_img_src(Tela_Yaxun, &back_240x320, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void create_iron(void)
{
    ...
    lv_obj_set_size(frame_iron, 148, 64);
    ...
    lv_obj_set_pos(frame_iron, 46, 20);
	...
	lv_label_set_text_fmt(iron_temperature, "%0.1f", temp_iron);
    lv_obj_align_to(iron_temperature, frame_iron, LV_ALIGN_CENTER, 0, 8);	// Align
    // Label Preset IRON
    preset_iron = lv_label_create(frame_iron);
    lv_obj_set_style_text_font(preset_iron, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(symbol_iron, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void create_air(void)
{
    ...
    lv_obj_set_size(frame_air, 148, 64);
    ...
    lv_obj_set_pos(frame_air, 46, 120);
	...
	lv_label_set_text_fmt(air_temperature, "%0.1f", temp_air);
    lv_obj_align_to(air_temperature, frame_air, LV_ALIGN_CENTER, 0, 8);		// Align
    // Label Preset Air
    preset_air = lv_label_create(frame_air);
    lv_obj_set_style_text_font(preset_air, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(symbol_air, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void screen_debug(void)
{
    ...
    lv_obj_set_style_text_font(adc_iron, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
	...
	lv_label_set_text_fmt(adc_iron, "ADC CH8: %ld - %0.1fmV Temp: %0.1f°C", ADC_iron, (float)(ADC_iron * ((float)3300.0/4095)), temp_iron);
	lv_obj_set_pos(adc_iron, 10, 24);
	//
    adc_air = lv_label_create(Tela_Debug);
    lv_obj_set_style_text_font(adc_air, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
	...
	lv_label_set_text_fmt(adc_air, "ADC CH9: %ld - %0.1fmV Temp: %0.1f°C", ADC_air, (float)(ADC_air * ((float)3300.0/4095)), temp_air);
	lv_obj_set_pos(adc_air, 10, 48);
	//
    enc_1 = lv_label_create(Tela_Debug);
    lv_obj_set_style_text_font(enc_1, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
	...
	lv_label_set_text_fmt(enc_1, "ENC_1 - Value: %ld  Dir: %ld  Btn: %ld", enc1_cnt, enc1_dir, enc1_btn);
	lv_obj_set_pos(enc_1, 10, 72);
	//
    enc_2 = lv_label_create(Tela_Debug);
    lv_obj_set_style_text_font(enc_2, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
	...
	lv_label_set_text_fmt(enc_2, "ENC_2 - Value: %ld  Dir: %ld Btn: %ld", enc2_cnt, enc2_dir, enc2_btn);
	lv_obj_set_pos(enc_2, 10, 96);
	//
    enc_3 = lv_label_create(Tela_Debug);
    lv_obj_set_style_text_font(enc_3, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
	...
	lv_label_set_text_fmt(enc_3, "ENC_3 - Value: %ld  Dir: %ld Btn: %ld ", enc3_cnt, enc3_dir, enc3_btn);
	lv_obj_set_pos(enc_3, 10, 120);

	label_sw_iron = lv_label_create(Tela_Debug);
    lv_obj_set_style_text_font(label_sw_iron, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(label_sw_iron, 10, 144);

	label_sw_air = lv_label_create(Tela_Debug);
    lv_obj_set_style_text_font(label_sw_air, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(label_sw_air, 10, 168);

    static uint32_t user_data = 10;
    task_debug = lv_timer_create(update_debug_screen, 100,  &user_data);
